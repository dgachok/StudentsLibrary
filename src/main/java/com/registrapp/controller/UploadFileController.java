...
public class UploadFileController {
    ...
    private void saveFile(File file, User user) throws IOException {
        ...
        multipartFile.transferTo(new java.io.File("students-atheneum.rhcloud.com\\var\\lib\\openshift\\56c9aa1e7628e104ec00001d\\app-root\\data\\"+multipartFile.getOriginalFilename()));
