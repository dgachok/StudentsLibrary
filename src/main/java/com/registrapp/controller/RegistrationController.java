...
public class RegistrationController {
    ...
    public String processRegistration(@ModelAttribute("RegistrationForm")User user, BindingResult result, ModelMap model) throws MessagingException, NoSuchAlgorithmException {
